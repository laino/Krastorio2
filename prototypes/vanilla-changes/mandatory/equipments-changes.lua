      ...
      if data.raw.item[item_name] then
        if not item[5] then -- tier
          ...
          data.raw.item[item_name].icons = {
            ...
            { icon = "__Krastorio2Assets__/icons/equipments/tiers/" .. tostring(item[5]) .. ".png", icon_size = 64 }, -- , scale = item[2]/64
          }
          data.raw.item[item_name].icon_size = item[2] -- icon size
        end
...
if data.raw.item["fusion-reactor-equipment"] then
  data.raw.item["fusion-reactor-equipment"].pictures = {
    layers = {
      {
        size = 64,
        filename = "__Krastorio2Assets__/icons/equipments/universal/" .. "fusion-reactor-equipment.png",
        scale = 0.25,
        mipmap_count = 4,
      },
      {
        ...
        flags = { "light" },
        size = 64,
        filename = "__Krastorio2Assets__/icons/equipments/universal/" .. "fusion-reactor-equipment-light.png",
        scale = 0.25,
        mipmap_count = 4,
      },
    },
...
krastorio.icons.setTechnologyIcons("fusion-reactor-equipment", {
  { icon = "__Krastorio2Assets__/technologies/fusion-reactor-equipment.png", icon_size = 256, icon_mipmaps = 4 },
