    ...
    layers = {
      {
        ...
        height = 64,
        hr_version = {
          filename = "__Krastorio2Assets__/entities/steel-pipe-covers/hr-steel-pipe-cover-north.png",
          priority = "extra-high",
          width = 128,
          height = 128,
          scale = 0.5,
    ...
    layers = {
      {
        ...
        height = 64,
        hr_version = {
          filename = "__Krastorio2Assets__/entities/steel-pipe-covers/hr-steel-pipe-cover-east.png",
          priority = "extra-high",
          width = 128,
          height = 128,
          scale = 0.5,
    ...
    layers = {
      {
        ...
        height = 64,
        hr_version = {
          filename = "__Krastorio2Assets__/entities/steel-pipe-covers/hr-steel-pipe-cover-south.png",
          priority = "extra-high",
          width = 128,
          height = 128,
          scale = 0.5,
    ...
    layers = {
      {
        ...
        height = 64,
        hr_version = {
          filename = "__Krastorio2Assets__/entities/steel-pipe-covers/hr-steel-pipe-cover-west.png",
          priority = "extra-high",
          width = 128,
          height = 128,
          scale = 0.5,
