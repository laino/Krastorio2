  ...
  layers = {
    {
      ...
      animation_speed = 0.5,
      hr_version = {
        filename = "__Krastorio2Assets__/entities/shelter-plus/hr-shelter-plus-light.png",
        priority = "high",
        width = 450,
        height = 450,
        scale = 0.45,
    ...
    },
    {
      ...
      animation_speed = 0.5,
      hr_version = {
        filename = "__Krastorio2Assets__/entities/shelter-plus/hr-shelter-plus.png",
        priority = "high",
        width = 450,
        height = 450,
        scale = 0.45,
    ...
    },
    {
      ...
      draw_as_shadow = true,
      hr_version = {
        filename = "__Krastorio2Assets__/entities/shelter-plus/hr-shelter-plus-sh.png",
        priority = "high",
        width = 520,
        height = 342,
        scale = 0.45,
    ...
    },
    {
      ...
      tint = s_tint,
      hr_version = {
        filename = "__Krastorio2Assets__/entities/shelter-plus/hr-shelter-plus-mask.png",
        flags = { "mask" },
        priority = "extra-high",
        width = 450,
        height = 450,
