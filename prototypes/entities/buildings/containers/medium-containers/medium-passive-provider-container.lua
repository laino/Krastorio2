  ...
  data:extend({
    {
      ...
      animation = {
        filename = "__Krastorio2Assets__/entities/containers/medium-containers/medium-passive-provider-container/medium-passive-provider-container.png",
        priority = "extra-high",
        width = 85,
        height = 85,
        frame_count = 6,
        hr_version = {
          filename = "__Krastorio2Assets__/entities/containers/medium-containers/medium-passive-provider-container/hr-medium-passive-provider-container.png",
          priority = "extra-high",
          width = 340,
          height = 340,
          frame_count = 6,
