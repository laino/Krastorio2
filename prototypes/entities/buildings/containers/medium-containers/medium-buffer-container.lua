  ...
  data:extend({
    {
      ...
      animation = {
        filename = "__Krastorio2Assets__/entities/containers/medium-containers/medium-buffer-container/medium-buffer-container.png",
        priority = "extra-high",
        width = 85,
        height = 85,
        frame_count = 6,
        hr_version = {
          filename = "__Krastorio2Assets__/entities/containers/medium-containers/medium-buffer-container/hr-medium-buffer-container.png",
          priority = "extra-high",
          width = 340,
          height = 340,
          frame_count = 6,
