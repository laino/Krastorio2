  ...
  data:extend({
    {
      ...
      animation = {
        filename = "__Krastorio2Assets__/entities/containers/big-containers/big-requester-container/big-requester-container.png",
        priority = "extra-high",
        width = 213,
        height = 213,
        frame_count = 6,
        ...
        scale = 1.2,
        hr_version = {
          filename = "__Krastorio2Assets__/entities/containers/big-containers/big-requester-container/hr-big-requester-container.png",
          priority = "extra-high",
          width = 512,
          height = 512,
          frame_count = 6,
