data:extend({
  {
    ...
    pictures = {
      up = {
        ...
        hr_version = {
          filename = "__Krastorio2Assets__/entities/steel-pipe-to-ground/hr-steel-pipe-to-ground-up.png",
          priority = "extra-high",
          width = 128,
          height = 128,
          scale = 0.5,
      ...
      down = {
        ...
        hr_version = {
          filename = "__Krastorio2Assets__/entities/steel-pipe-to-ground/hr-steel-pipe-to-ground-down.png",
          priority = "extra-high",
          width = 128,
          height = 128,
          scale = 0.5,
      ...
      left = {
        ...
        hr_version = {
          filename = "__Krastorio2Assets__/entities/steel-pipe-to-ground/hr-steel-pipe-to-ground-left.png",
          priority = "extra-high",
          width = 128,
          height = 128,
          scale = 0.5,
      ...
      right = {
        ...
        hr_version = {
          filename = "__Krastorio2Assets__/entities/steel-pipe-to-ground/hr-steel-pipe-to-ground-right.png",
          priority = "extra-high",
          width = 128,
          height = 128,
          scale = 0.5,
