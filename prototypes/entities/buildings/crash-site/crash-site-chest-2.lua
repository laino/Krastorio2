...
data:extend({
  {
    ...
    integration_patch = {
      ...
      line_length = 1,
      hr_version = {
        filename = "__Krastorio2Assets__/entities/crash-site/chests/hr-crash-site-chest-2-ground.png",
        width = 218,
        height = 186,
      ...
      layers = {
        {
          ...
          hr_version = {
            filename = "__Krastorio2Assets__/entities/crash-site/chests/hr-crash-site-chest-2.png",
            priority = "extra-high",
            width = 116,
            height = 88,
            shift = util.by_pixel(0, 8),
        ...
        },
        {
          ...
          draw_as_shadow = true,
          hr_version = {
            filename = "__Krastorio2Assets__/entities/crash-site/chests/hr-crash-site-chest-2-shadow.png",
            priority = "extra-high",
            width = 188,
            height = 126,
