...
data:extend({
  {
    ...
    integration_patch = {
      ...
      line_length = 1,
      hr_version = {
        filename = "__Krastorio2Assets__/entities/crash-site/assembling-machine/hr-crash-site-assembling-machine-1-ground.png",
        width = 446,
        height = 234,
      ...
      layers = {
        {
          ...
          hr_version = {
            filename = "__Krastorio2Assets__/entities/crash-site/assembling-machine/hr-crash-site-assembling-machine-1-repaired.png",
            width = 282,
            height = 182,
            frame_count = 20,
            line_length = 5,
        ...
        },
        {
          ...
          animation_speed = kr_crash_site_assembling_machine_1_repaired_animation_speed,
          hr_version = {
            filename = "__Krastorio2Assets__/entities/crash-site/assembling-machine/hr-crash-site-assembling-machine-1-repaired-shadow.png",
            width = 278,
            height = 168,
            frame_count = 20,
            line_length = 5,
    ...
    working_visualisations = {
      {
        animation = {
          ...
          animation_speed = kr_crash_site_assembling_machine_1_repaired_animation_speed,
          hr_version = {
            filename = "__Krastorio2Assets__/entities/crash-site/assembling-machine/hr-crash-site-assembling-machine-1-repaired-light.png",
            width = 162,
            height = 120,
            frame_count = 20,
            line_length = 5,
