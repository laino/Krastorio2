data:extend({
  {
    ...
    animation = {
      filename = "__Krastorio2Assets__/entities/remnants/transport-belts/advanced-transport-belt/underground-belt/advanced-underground-belt-remnant.png",
      line_length = 1,
      width = 60,
      height = 50,
      frame_count = 1,
      ...
      hr_version = {
        filename = "__Krastorio2Assets__/entities/remnants/transport-belts/advanced-transport-belt/underground-belt/hr-advanced-underground-belt-remnant.png",
        line_length = 1,
        width = 116,
        height = 100,
        frame_count = 1,
