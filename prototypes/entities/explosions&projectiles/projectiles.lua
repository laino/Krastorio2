...
data:extend({
...

  {
    ...
    shadow = {
      filename = "__Krastorio2Assets__/entities/missiles/rocket-shadow.png",
      frame_count = 1,
      width = 12,
      height = 40,
      priority = "high",
...

  {
    ...
    animation = {
      ...
      scale = 0.7,
      hr_version = {
        filename = "__Krastorio2Assets__/entities/bullets/hr-poop.png",
        frame_count = 12,
        animation_speed = 0.3,
        width = 64,
        height = 64,
...

  {
    ...
    animation = {
      ...
      priority = "high",
      hr_version = {
        filename = "__Krastorio2Assets__/entities/bullets/hr-virus-capsule.png",
        frame_count = 16,
        line_length = 8,
        animation_speed = 0.250,
        width = 58,
    ...
    shadow = {
      ...
      draw_as_shadow = true,
      hr_version = {
        filename = "__Krastorio2Assets__/entities/bullets/hr-virus-capsule-sh.png",
        frame_count = 16,
        line_length = 8,
        animation_speed = 0.25,
        width = 54,
