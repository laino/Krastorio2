data:extend({
  ...
  -- battery-mk3-equipment
  {
    ...
    icons = {
      { icon = "__Krastorio2Assets__/icons/equipments/universal/battery-mk3-equipment.png", icon_size = 64 },
      { icon = "__Krastorio2Assets__/icons/equipments/tiers/3.png", icon_size = 64 },
    },
    icon_size = 64,
    pictures = {
      layers = {
        {
          size = 64,
          filename = "__Krastorio2Assets__/icons/equipments/universal/battery-mk3-equipment.png",
          scale = 0.25,
          mipmap_count = 4,
        },
        {
  ...
  -- big-battery-equipment
  {
    ...
    icons = {
      { icon = "__Krastorio2Assets__/icons/equipments/universal/big-battery-equipment.png", icon_size = 64 },
      { icon = "__Krastorio2Assets__/icons/equipments/tiers/1.png", icon_size = 64 },
    },
    icon_size = 64,
    pictures = {
      layers = {
        {
          size = 64,
          filename = "__Krastorio2Assets__/icons/equipments/universal/big-battery-equipment.png",
          scale = 0.25,
          mipmap_count = 4,
        },
        {
  ...
  -- big-battery-mk2-equipment
  {
    ...
    icons = {
      { icon = "__Krastorio2Assets__/icons/equipments/universal/big-battery-mk2-equipment.png", icon_size = 64 },
      { icon = "__Krastorio2Assets__/icons/equipments/tiers/2.png", icon_size = 64 },
    },
    icon_size = 64,
    pictures = {
      layers = {
        {
          size = 64,
          filename = "__Krastorio2Assets__/icons/equipments/universal/big-battery-mk2-equipment.png",
          scale = 0.25,
          mipmap_count = 4,
        },
        {
  ...
  -- big-solar-panel-equipment
  {
    ...
    icons = {
      { icon = "__Krastorio2Assets__/icons/equipments/universal/big-solar-panel-equipment.png", icon_size = 64 },
      { icon = "__Krastorio2Assets__/icons/equipments/tiers/1.png", icon_size = 64 },
    },
    icon_size = 64,
  ...
  -- personal-submachine-laser-defense-mk1-equipment
  {
    ...
    icons = {
      { icon = "__Krastorio2Assets__/icons/equipments/universal/personal-submachine-laser-defense-mk1-equipment.png" },
      { icon = "__Krastorio2Assets__/icons/equipments/tiers/1.png", icon_size = 64 },
    },
    icon_size = 64,
  ...
  -- personal-submachine-laser-defense-mk2-equipment
  {
    ...
    icons = {
      { icon = "__Krastorio2Assets__/icons/equipments/universal/personal-submachine-laser-defense-mk2-equipment.png" },
      { icon = "__Krastorio2Assets__/icons/equipments/tiers/2.png", icon_size = 64 },
    },
    icon_size = 64,
  ...
  -- personal-submachine-laser-defense-mk4-equipment
  {
    ...
    icons = {
      { icon = "__Krastorio2Assets__/icons/equipments/universal/personal-submachine-laser-defense-mk4-equipment.png" },
      { icon = "__Krastorio2Assets__/icons/equipments/tiers/4.png", icon_size = 64 },
    },
    icon_size = 64,
  ...
  -- shield mk3
  {
    ...
    icons = {
      {
        icon = "__Krastorio2Assets__/icons/equipments/universal/energy-shield-mk3-equipment.png",
        icon_size = 64,
        mipmap_count = 4,
      },
      { icon = "__Krastorio2Assets__/icons/equipments/tiers/3.png", icon_size = 64 },
