data:extend({
  ...
  -- additional-engine
  {
    ...
    sprite = {
      ...
      priority = "medium",
      hr_version = {
        filename = "__Krastorio2Assets__/equipments/vehicle/hr-additional-engine.png",
        width = 256,
        height = 256,
        priority = "medium",
        scale = 0.5,
  ...
  -- advanced-additional-engine
  {
    ...
    sprite = {
      ...
      priority = "medium",
      hr_version = {
        filename = "__Krastorio2Assets__/equipments/vehicle/hr-advanced-additional-engine.png",
        width = 256,
        height = 256,
        priority = "medium",
        scale = 0.5,
  ...
  -- vehicle-roboport
  {
    ...
    sprite = {
      ...
      priority = "medium",
      hr_version = {
        filename = "__Krastorio2Assets__/equipments/vehicle/hr-vehicle-roboport.png",
        width = 256,
        height = 256,
        priority = "medium",
        scale = 0.5,
